			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="mv-findTop-title">평가한 작품들</div>
					</div>
				</div>
			</div>
						...
						<form class="form-horizontal" id='login_modal_form' name='login_modal_form' method="post">
							...
							<div>
								<p class="text-center madal_text">
									계정이 없으신가요?
									<button type="button" class="btn btn-default" id='btn_modal_join'
										data-toggle="modal" data-target="#join-Modal"
										onclick='modal_hide()'>회원가입</button>
								</p>
							</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form class="form-horizontal" id='join_modal_form' name='login_modal_form' method="post">
							<div class="form-group">
								<div class="col-xs-12">
									<input type="text" class="form-control j_m" id="main_join_name"
										name="main_join_name" placeholder="이름">
									<div id="name_text">
							...
							<div class="form-group">
								<div class="col-xs-12">
									<input type="email" class="form-control j_m" id="main_join_email"
										name="main_join_email" placeholder="이메일">
									<div id="email_text2">
							...
							<div class="form-group">
								<div class="col-xs-12">
									<input type="text" class="form-control j_m" id="main_join_phone"
										name="main_join_phone" placeholder="핸드폰번호">
									<div id="phone_text">
							...
							<div class="form-group">
								<div class="col-xs-12">
									<input type="password" class="form-control j_m" id="main_join_pwd"
										name="main_join_pwd" placeholder="비밀번호">
								</div>
							</div>
							...
							<div>
								<p class="text-center madal_text" id="modal_text">
									...
									<button type="button" class="btn btn-default" id='btn_modal_join_Save'
										...
										onclick='modal_hide2()'>로그인</button>
								</p>
							</div>
						</form>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-default btn-lg btn-block" id='btn_modal_naver_login'>네이버
							아이디로
							로그인</button>
					</div>
			...
			<div class="modal-dialog" style="position:relative;top: 96px;width: 371px;">
				<div class="modal-content">
					...
					<div class="modal-body" style="font-size: 16px;">
						...
						<div style="font-size: 13px;color: #aaa;margin-bottom: 7px;font-weight: bold;">가입했던 이메일을 적어주세요
						</div>
						<div style="font-size: 13px;color: #aaa;margin-bottom: 38px;font-weight: bold;">입력하신 이메일 주소로
							비밀번호를
							보낼게요</div>
						<form class="form-horizontal" id='pwdFind_modal_form' name='pwdFind_modal_form' method="post">
							<div class="form-group">
								<div class="col-xs-12">
									<input type="email" class="form-control j_m" id="find_pwd_email"
										name="find_pwd_email" placeholder="example@google.com">
									<div id="email_text3">
						...
						<div>
							<button type="button" class="btn btn-default btn-lg btn-block" id='btn_find_pwd_send'>비밀번호
								변경
								이메일 보내기</button>
						</div>
					</div>
