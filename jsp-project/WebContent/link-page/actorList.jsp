...
<%
	...
	SCDao dao = new SCDao();
	List<SCActorVo> list = dao.actorList(cId);
...
<!--   <header class="hd">
            ...
            <div class="container-fluid">타이틀/뒤로가기
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="mv-findTop-title">출연/제작</div>
                    </div>
                </div>
            </div>
    ...
    <%@include file="/link-page/actorList-top.jsp"%>
					...
					<div class="rank-plus-1">
						<a href="/link-page/actors.jsp?aId=${item.aId}&aName=${item.aName}">
							...
							<div class="rank-plus-des">
								<div class="rank-plus-des-title">${item.aName }</div>
								<div class="rank-plus-des-year">★${item.position }</div>
							</div>
						</a>
					</div>
				</li>
