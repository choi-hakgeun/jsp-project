...
<body>
	<header class="hd">
		<nav class="navbar navbar-default navbar-fixed-top">
						...
						<div class="form-group">
							<div class="input-group" id="profile-group">
								...
								<span class="input-group-addon span2" id="logout-span" data-toggle="tooltip"
									...
									<a href="javascript:select()"><img src="/lib/images/default_profile.png"
			...
			<div class="container-fluid comment_start">
				<div class="row">
					<div class="col-xs-12 comment_top_button">
						<div class="col-xs-12 comment_top">
							<div class="col-xs-3">
								<button type="button" class="btn btn-default back" aria-label="Left Align">
									<span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>
								</button>
							</div>
							<div class="col-xs-6 page-header">
								코멘트
							</div>
						</div>
					</div>
