...
<body>
  ...
  <ul class="nav nav-tabs mmp-ul" role="tablist">
    ...
    <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">점수별</a></li>
  </ul>
